...
class SignatureFooterTests(unittest.TestCase):
    ...
    def test_outbound_clause_dashes_remain_readable(self):
        cases = [
            ...
            ("Everything I needed―I’ll follow up.", "Everything I needed - I'll follow up."),
            ("Everything I needed — I’ll follow up.", "Everything I needed - I'll follow up."),
            ("Thanks–please review it.", "Thanks - please review it."),
            ("Everything is ready–I can follow up.", "Everything is ready - I can follow up."),
            ("Everything is ready–let me know.", "Everything is ready - let me know."),
