...
env_vars="FIREBASE_BUCKET=email-automation-cache.firebasestorage.app,ENFORCE_OPENAI_BUDGET=1,USAGE_MONTHLY_BUDGET_USD=100,SITESIFT_PROVIDER_EFFECTS_ENABLED=true,SITESIFT_OUTBOUND_MODE=live,SITESIFT_EFFECT_MAX_ATTEMPTS=3,SITESIFT_EFFECT_MAX_PER_RUN=100,SITESIFT_EFFECT_MAX_PER_USER=50,SITESIFT_EFFECT_MAX_PER_PROVIDER=100"
